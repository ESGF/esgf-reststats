...
public enum SqlQuery {
	...
	/** cordex **/
    CORDEX_CLIENTS_HOST_GEOLOCATION("SELECT * FROM esgf_dashboard.cordex_dmart_clients_host_geolocation;"),
    CORDEX_MODEL_HOST_TIME("SELECT * FROM esgf_dashboard.cordex_dmart_model_host_time;"),
    CORDEX_EXPERIMENT_HOST_TIME("SELECT * FROM esgf_dashboard.cordex_dmart_experiment_host_time;"),
    CORDEX_VARIABLE_HOST_TIME("SELECT * FROM esgf_dashboard.cordex_dmart_variable_host_time;"),
    CORDEX_DATASET_HOST_TIME("SELECT * FROM esgf_dashboard.cordex_dmart_dataset_host_time;");
    /** cordex **/

...
@XmlRootElement
public class HostTimeGeolocation {
	...
	public HostTimeGeolocation() {
		super();
	}
	
	public HostTimeGeolocation(Long total_size, Long number_of_downloads, Long number_of_successful_downloads,
									Integer average_duration, Integer number_of_users, Long number_of_replica_downloads, String host_name,
									Integer month, Integer year, Double latitude, Double longitude) {
		super();

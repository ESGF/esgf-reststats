...
public class ClientsHostGeolocationController {
	...
	public Table<Row> getXml() throws SQLException {
        ...
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement(SqlQuery.CMIP5_CLIENTS_HOST_GEOLOCATION.getSql());
	    ...
	    listOfRows.setName("cmip5_dmart_clients_host_geolocation");

...
@XmlRootElement
public class ExperimentHostTime {
	...
	public ExperimentHostTime() {
		super();
	}
	
	public ExperimentHostTime(Long total_size, Long number_of_downloads, Long number_of_successful_downloads,
			Integer average_duration, Integer number_of_users, Long number_of_replica_downloads, String host_name,
			Integer month, Integer year, String experiment_name) {
		super();

...
public class VariableHostTimeController {
	...
	public Table<Row> getXml() throws SQLException {
        ...
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement(SqlQuery.CORDEX_VARIABLE_HOST_TIME.getSql());
	    ...
	    listOfRows.setName("cordex_dmart_variable_host_time");

...
public class ModelHostTimeController {
	...
	public Table<Row> getXml() throws SQLException {
        ...
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement(SqlQuery.CORDEX_MODEL_HOST_TIME.getSql());
            ...
            while (rs.next()) {
                ...
                model_name.setName("model_name");
                model_name.setValue(String.valueOf(rs.getString("model_name")));     
	    ...
	    listOfRows.setName("cordex_dmart_model_host_time");

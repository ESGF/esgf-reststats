...
public class SourceHostTime {
	...
	private String  source_id_name;
	
	public SourceHostTime() {
		super();
	}

	public SourceHostTime(Long total_size, Long number_of_downloads, Long number_of_successful_downloads,
			Integer average_duration, Integer number_of_users, Integer month, Integer year, String host_name,
			String source_id_name) {
		super();

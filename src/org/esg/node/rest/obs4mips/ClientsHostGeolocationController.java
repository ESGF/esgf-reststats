...
public class ClientsHostGeolocationController {
	...
	public Table<Row> getXml() throws SQLException {
        ...
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement(SqlQuery.OBS_DMART_CLIENTS_HOST_GEOLOCATION.getSql());
	    ...
	    listOfRows.setName("obs4mips_dmart_clients_host_geolocation");

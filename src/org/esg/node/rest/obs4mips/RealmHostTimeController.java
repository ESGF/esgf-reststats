	...
	public Table<Row> getXml() throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Field realm_name = new Field();
                realm_name.setName("realm_name");
                realm_name.setValue(String.valueOf(rs.getString("realm_name")));     
                rowsArray.add(realm_name);
	    ...
	    listOfRows.setName("obs4mips_dmart_realm_host_time");

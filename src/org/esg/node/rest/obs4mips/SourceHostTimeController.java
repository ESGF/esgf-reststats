	...
	public Table<Row> getXml() throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Field source_id_name = new Field();
                source_id_name.setName("source_id_name");
                source_id_name.setValue(String.valueOf(rs.getString("source_id_name")));     
                rowsArray.add(source_id_name);
	    ...
	    listOfRows.setName("obs4mips_dmart_source_host_time");

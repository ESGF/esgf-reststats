...
@Path("/historical-stats-by-continent/obs4mips-project")
public class Obs4mipsDataUsageContinentController {
	...
	public Table<Row> getXml() throws SQLException {
        ...
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement(SqlQuery.OBS4MIPS_DATA_USAGE_CONTINENT.getSql());
	    ...
	    listOfRows.setName("obs4mips_data_usage_continent");

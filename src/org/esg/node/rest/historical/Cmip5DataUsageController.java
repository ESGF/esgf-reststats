...
@Path("/historical-stats/cmip5-project")
public class Cmip5DataUsageController {
	...
	public Table<Row> getXml() throws SQLException {
        ...
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement(SqlQuery.CMIP5_DATA_USAGE.getSql());
	    ...
	    listOfRows.setName("cmip5_data_usage");

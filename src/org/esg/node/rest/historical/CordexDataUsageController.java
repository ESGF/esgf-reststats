...
@Path("/historical-stats/cordex-project")
public class CordexDataUsageController {
	...
	public Table<Row> getXml() throws SQLException {
        ...
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement(SqlQuery.CORDEX_DATA_USAGE.getSql());
	    ...
	    listOfRows.setName("cordex_data_usage");

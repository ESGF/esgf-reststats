...
@Path("/historical-stats-by-continent/cmip5-project")
public class Cmip5DataUsageContinentController {
	...
	public Table<Row> getXml() throws SQLException {
        ...
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement(SqlQuery.CMIP5_DATA_USAGE_CONTINENT.getSql());
	    ...
	    listOfRows.setName("cmip5_data_usage_continent");

...
@Path("/historical-stats-by-continent/cordex-project")
public class CordexDataUsageContinentController {
	...
	public Table<Row> getXml() throws SQLException {
        ...
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement(SqlQuery.CORDEX_DATA_USAGE_CONTINENT.getSql());
	    ...
	    listOfRows.setName("cordex_data_usage_continent");

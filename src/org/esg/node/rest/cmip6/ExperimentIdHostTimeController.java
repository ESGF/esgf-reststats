...
@Path("/cmip6/stats-by-experiment-id")
public class ExperimentIdHostTimeController {
	...
	public Table<Row> getXml() throws SQLException {
        ...
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement(SqlQuery.CMIP6_EXPERIMENTID_HOST_TIME.getSql());
            ...
            while (rs.next()) {
                ...
                experiment_name.setName("experiment_id_name");
                experiment_name.setValue(String.valueOf(rs.getString("experiment_id_name")));     
	    ...
	    listOfRows.setName("cmip6_dmart_experiment_id_host_time");

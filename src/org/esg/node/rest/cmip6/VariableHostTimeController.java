...
public class VariableHostTimeController {
	...
	public Table<Row> getXml() throws SQLException {
        ...
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement(SqlQuery.CMIP6_VARIABLE_HOST_TIME.getSql());
	    ...
	    listOfRows.setName("cmip6_dmart_variable_host_time");

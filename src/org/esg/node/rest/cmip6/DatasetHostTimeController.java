...
public class DatasetHostTimeController {
	...
	public Table<Row> getXml() throws SQLException {
        ...
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement(SqlQuery.CMIP6_DATASET_HOST_TIME.getSql());
	    ...
	    listOfRows.setName("cmip6_dmart_dataset_host_time");

...
public class ClientsHostGeolocationController {
	...
	public Table<Row> getXml() throws SQLException {
        ...
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement(SqlQuery.CMIP6_CLIENTS_HOST_GEOLOCATION.getSql());
	    ...
	    listOfRows.setName("cmip6_dmart_clients_host_geolocation");
